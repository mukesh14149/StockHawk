...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
  ...
  protected void onCreate(Bundle savedInstanceState) {
          ...
          new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
              ...
              .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                  ...
                  if (c.getCount() != 0) {
                    Toast toast =
                        Toast.makeText(MyStocksActivity.this, mContext.getResources().getString(R.string.stock_present),
                            Toast.LENGTH_LONG);
    ...
    descNoStock= (TextView) findViewById(R.id.noStock);
  }
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor data){
    if(data.getCount()<=0){
      descNoStock.setVisibility(View.VISIBLE);
    }
    else{
      descNoStock.setVisibility(View.GONE);
    }
